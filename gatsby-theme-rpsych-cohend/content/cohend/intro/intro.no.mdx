...
For å forenkle tolkningen presenteres Cohens *d* på flere forskjellige måter i denne visualiseringen: Visuelt overlapp, Cohen's U<sub>3</sub>, *probability of superiority*, prosentuelt overlapp, og *number needed to treat*.  Du kan også endre standardavviet samt se den ustandardiserte forskjellen.

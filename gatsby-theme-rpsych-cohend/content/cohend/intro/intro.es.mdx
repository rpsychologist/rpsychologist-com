...
Para facilitar la interpretación de la *d* de Cohen, esta visualización ofrece las siguientes representaciones: la superposición visual, la U<sub>3</sub> de Cohen, la probabilidad de superioridad, el porcentaje de superposición y el número necesario para tratar. También permite cambiar la desviación estándar y muestra la diferencia no estandarizada.
